...
export const AnimatedTestimonials = ({
  ...
  const getRotation = (index: number) => {
    ...
    // Use consistent rotation based on index instead of random
    const rotations = [-7, 4, -6, 9, -4, 6, -8, 3];
      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-white/10 border border-white/20 backdrop-blur-sm hover:bg-white/20 transition-all duration-300"
            >
